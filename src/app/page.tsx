  ...
  return (
    ...
    >
      <div className="px-6 py-4">
        ...
        <div className="mt-2 flex flex-wrap gap-3 text-xs text-gray-900">
          {device.mesh_role && (
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
          <div className="bg-white rounded-lg shadow p-4">
            <h3 className="text-xs font-medium text-gray-900">Total Devices</h3>
            <p className="text-2xl font-bold text-gray-900">{devices.length}</p>
          </div>
          <div className="bg-white rounded-lg shadow p-4">
            <h3 className="text-xs font-medium text-gray-900">Online</h3>
            <p className="text-2xl font-bold text-green-600">{onlineCount}</p>
          </div>
          <div className="bg-white rounded-lg shadow p-4">
            <h3 className="text-xs font-medium text-gray-900">Soil Sensors</h3>
            <p className="text-2xl font-bold text-cyan-600">{sensorDevices.length}</p>
          </div>
          <div className="bg-white rounded-lg shadow p-4">
            <h3 className="text-xs font-medium text-gray-900">Cameras</h3>
            <p className="text-2xl font-bold text-purple-600">{cameraDevices.length}</p>
          </div>
          <div className="bg-white rounded-lg shadow p-4">
            <h3 className="text-xs font-medium text-gray-900">Recent Readings</h3>
        ...
        <div className="bg-white rounded-lg shadow mb-6">
          <div className="px-6 py-4 border-b">
            <h2 className="text-lg font-semibold text-gray-900">
              Soil Sensors
              <span className="ml-2 text-sm font-normal text-gray-900">({sensorDevices.length})</span>
            </h2>
          </div>
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="px-6 py-4 border-b">
            <h2 className="text-lg font-semibold text-gray-900">
              Cameras
              <span className="ml-2 text-sm font-normal text-gray-900">({cameraDevices.length})</span>
            </h2>
          </div>
